    ...
    <body id="BgImage">
        <div class="container w-50 bg-dark ForDiv">
            <form action="" method="post">
                ...
                <div class="row p-2">
                    <div class="col-md-4 text-center ForFont">Name</div>
                    <div class="col-md-8">
                        <input type="text" name="Name" placeholder="Enter Employee Name Here" class="form-control TextBox" required onkeypress="return(event.charCode>=65 && event.charCode<=90) || (event.charCode>=97 && event.charCode<=122) || (event.charCode==32)">
                    </div>
                </div>

                <div class="row p-2">
                    <div class="col-md-4 text-center ForFont">Email</div>
                    <div class="col-md-8">
                ...
                <div class="row p-2">
                    <div class="col-md-4 text-center ForFont">Mobile No</div>
                    <div class="col-md-8">
                        <input type="text" name="MobileNo" placeholder="Enter Employee Mobile No Here" class="form-control TextBox" required onkeypress="return(event.charCode>=48 && event.charCode<=57)" minlength="10" maxlength="10">
                    </div>
                </div>

                <div class="row p-2">
                    <div class="col-md-4 text-center ForFont">Basic Salary</div>
                    <div class="col-md-8">
                ...
                <div class="row p-3">
                    <div class="col-md-4">
                        <a href="GetData.php" class="btn Button"> Show Data </a>
                    </div>
