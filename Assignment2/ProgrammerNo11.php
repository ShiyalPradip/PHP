    ...
    <body id="BgImage">
        <div class="container w-50 bg-dark ForDiv">
            <form action="" method="post">
                ...
                <div class="row p-2">
                    <div class="col-4 ForFont"> Enter a String </div>
                    <div class="col-8">
                        <input type="text" name="String" placeholder="Enter a String Here" class="form-control TextBox" required onkeypress="return(event.charCode>=65 && event.charCode<=90) || (event.charCode>=97 && event.charCode<=122)"/>
                    </div>
                </div>
