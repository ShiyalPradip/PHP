    ...
    <body id="BgImage">
        <div class="container bg-dark w-50 text-white ForDiv">
            <form action="" method="post" enctype="multipart/form-data">
                <div class="row p-3">
                    <div class="col h3 text-center"> Student Registration</div>
                </div>

                <div class="row p-2">
                    <div class="col-4 ForFont"> Name </div>
                    <div class="col-8">
                        <input type="text" name="Name" id="" class='form-control TextBox' placeholder="Enter Your Name Here" required onkeypress="return(event.charCode>=65 && event.charCode<=90) || (event.charCode>=97 && event.charCode<=122)">
                    </div>
                </div>
                ...
                <div class="row p-2">
                    ...
                    <div class="col-8">
                        <input type="number" name="Pincode" id="" class="form-control TextBox" placeholder="Enter Your Pincode Here" required onkeypress="return(event.charCode>=48 && event.charCode<=57)" mainlength="6" maxlength="6">
                    </div>
                </div>
                ...
                <div class="row p-2">
                    ...
                    <div class="col-8">
                        <input type="tel" name="MobileNo" id="" class="form-control TextBox" placeholder="Enter Your Mobile Number Here" required onkeypress="return(event.charCode>=48 && event.charCode<=57)">
                    </div>
                </div>
                ...
                <div class="row p-2">  
                    <div class="col-4 ForFont"> Your Photo</div>
                    <div class="col-8">
                        <input type="file" name="Profile" id="" class="form-control TextBox" required accept=".jpg,.png.jpeg">
                    </div>
                </div>
