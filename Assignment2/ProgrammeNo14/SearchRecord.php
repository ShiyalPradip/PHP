    ...
    <body id='BgImage'>
        <div class='bg-dark p-3'>
            <form method='post'>
                <div class='row'>
                    <div class='col-4'> 
                        <input type='text' name='Name' class='form-control TextBox' placeholder='Search Record By Name' onkeypress="return(event.charCode>=65 && event.charCode<=90) || (event.charCode>=97 && event.charCode<=122) || (event.charCode==32)"/>
                    </div>
