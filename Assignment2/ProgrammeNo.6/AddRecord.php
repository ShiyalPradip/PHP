        ...
        <div class="container bg-dark w-50 text-white ForDiv">
            <form action="" method="post">
                ...
                <div class="row p-2">
                    ...
                    <div class="col-8">
                        <input type="text" name="BookName" id="" placeholder="Enter a Book Name Here" class="form-control TextBox" required onkeypress="return(event.charCode>=65 && event.charCode<=90) || (event.charCode>=97 && event.charCode<=122)">
                    </div>
                </div>
                ...
                <div class="row p-2">
                    ...
                    <div class="col-8">
                        <input type="text" name="AuthorName" id="" placeholder="Enter Author Name Here" class="form-control TextBox" required  onkeypress="return(event.charCode>=65 && event.charCode<=90) || (event.charCode>=97 && event.charCode<=122)">
                    </div>
                </div>
