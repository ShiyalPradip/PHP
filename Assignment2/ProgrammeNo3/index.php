        ...
        <div class="container w-50 bg-dark text-white ForDiv">
            <form action="" method="post">
                ...
                <div class="row p-2">
                    ...
                    <div class="col-8">
                        <input type="text" name="Stud_Name" placeholder="Enter Your Name Here" class="form-control" id="TextBox" onkeypress="return(event.charCode>=65 && event.charCode<=90) || (event.charCode>=97 && event.charCode<=122)" required>
                    </div>
                </div>
                ...
                <div class="row p-2 ForFont">
                    ...
                    <div class="col-8">
                        <input type="number" name="Stud_Tol_Marks" placeholder="Enter Total Marks Here" id="TextBox" class="form-control" required onkeypress="return(event.charCode>=48 && event.charCode<=57)"/>
                    </div>
                </div>

                <div class="row p-4 text-center">
                    <div class="col-4">
                        <a href="ShowData.php" class="btn" id="Button"> Show Data </a>
                    </div>    
