        ...
        <div class="container w-50 bg-dark ForDiv">
            <form action="" method="post">
                ...
                <div class="row p-2">
                    ...
                    <div class="col-8">
                        <input type="text" name="Stud_Name" placeholder="<?php echo $Stud_Name;?>" id="TextBox" class="form-control" required>
                    </div>
                </div>
                ...
                <div class="row p-2 ForFont">
                    ...
                    <div class="col-8">
                        <input type="number" name="Stud_Tol_Marks" placeholder="<?php echo $Stud_Tol_Marks;?>" id="TextBox" class="form-control" required/>
                    </div>
                </div>
