...
<html lang="en">
    ...
    <body id="BgImage">
        <div class="container w-50 bg-dark ForDiv img-fluid">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="row p-1">
                    <div class="col-md-3 UName"> Name </div>
                    <div class="col-md-9">
                ...
                <div class="row p-2">
                    <div class="col-md-3 UName"> Username </div>
                    <div class="col-md-9">
                ...
                <div class="row p-2">
                    <div class="col-md-3 UName"> Password </div>
                    <div class="col-md-9">
                ...
                <div class="row p-2"> 
                    <div class="col-md-3 UName"> Address</div>
                    <div class="col-md-9">
                ...
                <div class="row p-2">
                    <div class="col-md-3 UName"> Email </div>
                    <div class="col-md-9">
                ...
                <div class="row p-2">
                    <div class="col-md-3 UName"> Gender</div>
                ...
                <div class="row p-2">
                    <div class="col-md-3 UName"> Contact No </div>
                    <div class="col-md-9">
    ...
    <?php
        ...
        if(isset($_POST['SignUp'])){
            ...
            $Insert = "insert into login_logout(Name,Username,Password,MasterPass,Address,Email,Gender,ContactNo,Profile)values('$Name','$Username','$Password',''$Password',$Address','$Email','$Gender','$ContactNumber','$Path')";
