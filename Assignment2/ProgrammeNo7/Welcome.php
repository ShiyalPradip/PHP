<?php
        ...
        if($Trigger){
            ...
            echo("
                <table class='table'>
                    <tr class='Heading'>
                        ...
                        <td align='right'> 
                            <form method='post'> 
                                <input type='submit' value='Update' name='Update' class='btn Button BtnMargin'> 
                                <input type='submit' value='Delete' name='Delete' class='btn Button BtnMargin'> 
            ...
            echo("
                <div class='container For-Shadow text-white w-50'>
                    ...
                    <div class='row p-3'> <div class='col-6 Data'> MasterPass : </div> <div class='col-6 Fields-Data'> $MasterPass    </div> </div>
                    ...
                    <div class='row p-3'> <div class='col-6 Data'> Contact :    </div> <div class='col-6 Fields-Data'> $ContactNo     </div> </div>
                </div>
            ");
        }
    }else{
    ...
    if(isset($_POST['LogOut'])){
        ...
        echo("
            <script>
                var Delete = confirm('Are You Sure You Want To Delete This Account Permanently🔐');
