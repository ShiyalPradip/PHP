    ...
    <body id="BgImage">
        <div class="container bg-dark w-50 text-white ForDiv">
            <form action="" method="post">
                ...
                <div class="row p-3">
                    <div class="col-md-4"> <input type="radio" name="Calcu" id="Add"  onclick="CheckNow()"  class="form-check-input"> <b> Addition </b>       </div>
                    <div class="col-md-4"> <input type="radio" name="Calcu" id="Sub"  onclick="CheckNow()" class="form-check-input"><b> Subtraction     </b> </div>
                    <div class="col-md-4"> <input type="radio" name="Calcu" id="Mul"  onclick="CheckNow()"  class="form-check-input"> <b> Multiplication </b> </div>
                </div>
            </form>
        </div>
    </body>    
