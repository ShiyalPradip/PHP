        ...
        <div class="container w-50 bg-dark text-white ForDiv">
            <form action="DisplayData.php" method="post">
                ...
                <div class="row p-2">
                    ...
                    <div class="col-9">
                        <input type="text" name="Username" id="" placeholder="Enter Your Username Here" class="form-control TextBox" onkeypress="return(event.charCode>=64 && event.charCode<=91) || (event.charCode>= 96 && event.charCode<=122)" required/>
                    </div>
                </div>
                ...
                <div class="row p-2">
                    ...
                    <div class="col-9">
                        <input type="tel" name="PhoneNo" id=""  pattern="[0-9]+" placeholder="Enter Your Phone Number Here" class="form-control TextBox" maxlength="10" minlength="10" required />
                    </div>
                </div>
