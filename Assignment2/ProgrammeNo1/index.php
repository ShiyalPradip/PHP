    ...
    <body id="BgImage">
        <div class="container w-50 bg-dark text-white ForDiv">
            <form action="DisplayData.php" method="post">
                ...
                <div class="row p-2">
                    <div class="col-md-3 ForFont"> Username</div>
                    <div class="col-md-9">
                ...
                <div class="row p-2">
                    <div class="col-md-3 ForFont"> Gender </div>
                    <div class="col-md-9">
                ...
                <div class="row p-2">
                    <div class="col-md-3 ForFont">Course</div>
                    <div class="col-md-9">
                ...
                <div class="row p-2">
                    <div class="col-md-3 ForFont"> City </div>
                    <div class="col-md-9">
                ...
                <div class="row p-2">
                    <div class="col-md-3 ForFont"> Phone No</div>
                    <div class="col-md-9">
