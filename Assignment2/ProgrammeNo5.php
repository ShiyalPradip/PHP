    ...
    <body id="BgImage">
        <div class="container bg-dark w-50 ForDiv">
            <form action="" method="post">
                ...
                <div class="row p-2">
                    <div class="col-4 ForFont"> Id </div>
                    <div class="col-8">
                ...
                <div class="row p-2">
                    ...
                    <div class="col-8">
                        <input type="text" name="RegName" id="" placeholder="Enter Your Registration Name Here" class="form-control TextBox" required onkeypress="return(event.charCode>=65 && event.charCode<=90) || (event.charCode>=97 && event.charCode<=122)"/>
                    </div>
                </div>
                ...
                <div class="row p-2">
                    <div class="col-4 ForFont"> Contact </div>
                    <div class="col-8">
                        <input type="tel" name="RegCon" pattern="[0-9]+" id="" placeholder="Enter Your Registration Contact Here" class="form-control TextBox" required minlength="10" maxlength="10"/>
                    </div>
                </div>
