        ...
        <div class="container w-50 bg-dark ForDiv">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="row p-1">
                    ...
                    <div class="col-9">
                        <input type="text" name="Name" id="" class="form-control TextBox" placeholder="Enter Your Name Here" required onkeypress="return(event.charCode>=65 && event.charCode<=90) || (event.charCode>=97 && event.charCode<=122)" value="<?php echo @$Name; ?>">
                    </div>
                </div>
                ...
                <div class="row p-2">
                    ...
                    <div class="col-9">
                        <input type="tel" name="ContactNumber" id="" class="form-control TextBox" placeholder="Enter Your Contact Number Here" minlength="10" maxlength="10" required onkeypress="return(event.charCode>=48 && event.charCode<=57)" value="<?php echo @$ContactNumber; ?>">
                    </div>
                </div>
