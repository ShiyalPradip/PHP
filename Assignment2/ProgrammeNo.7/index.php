        ...
        <div class="container w-50 bg-dark ForDiv">
            <form action="#" method="post">
                ...
                <div class="row p-2">
                    ...
                    <div class="col-8">
                        <input type="password" name="Password" id="" class="form-control TextBox bi bi-eye-slash" placeholder="Enter Your Password Here" required minlength="8" maxlength="18">
                    </div>
                </div>
