        ...
        <div class="container bg-dark w-50 text-white ForDiv">
            <form action="" method="post">
                ...
                <div class="row p-2">
                    ...
                    <div class="col-8">
                        <input type="text" name="BookName" id="" placeholder="<?php echo $BookName; ?>" class="form-control TextBox" required  onkeypress="return(event.charCode>=65 && event.charCode<=90) || (event.charCode>=97 && event.charCode<=122) || event.charCode==32">
                    </div>
                </div>
                ...
                <div class="row p-2">
                    ...
                    <div class="col-8">
                        <input type="text" name="AuthorName" id="" placeholder="<?php echo $AuthorName; ?>" class="form-control TextBox" required onkeypress="return(event.charCode>=65 && event.charCode<=90) || (event.charCode>=97 && event.charCode<=122) || event.charCode==32">
                    </div>
                </div>
