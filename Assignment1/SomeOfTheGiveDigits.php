    ...
    <body class="Bg_Image">
        <div class="Image container BgColor">
            <form action="" method="post">
                <div class="row">
                    <div class="col text-center p-3 h2 text-white"> Sum Of The Given Digit </div>
                </div>
                ...
                <div class="row">
                    <div class="col text-center p-3 "> <input type="submit" value="Calculate" name="Button" class="btn bg-dark text-white"> </div>
                </div>
            </form>
        </div>
    </body>
